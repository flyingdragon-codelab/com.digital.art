 ...
 //   print(profile);
    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          children: [
            Text((user == null ? 'Login' : 'Hola ' + userProfile["Name"] + '!' )),
            ...
            GestureDetector(
              ...
              onTap: () async {
                (user == null)
                    ...
                    : {await FirebaseAuth.instance.signOut(), setState(() {user = null;}), };
              },
            )
          ],
        ),
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text((user == null ? '' : '' ) ,style: TextStyle(fontSize: 25.0,fontWeight: FontWeight.bold),),
                              ],
                            ),
                          ),
